      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden flex flex-col text-slate-800">
        ...
        <div className="px-5 py-4 border-b border-slate-200 flex items-center justify-between bg-slate-50/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-base text-[#181E2B]">Gem til Projekt</h3>
          ...
          {!isCreatingNew ? (
            <>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs text-[#E52328] font-bold hover:underline flex items-center gap-1 cursor-pointer"
                >
              ...
              {projects.length === 0 ? (
                <div className="text-center py-8 px-4 bg-slate-50 rounded-xl border border-dashed border-slate-300 space-y-3">
                  ...
                  <button
                    onClick={() => setIsCreatingNew(true)}
                    className="px-4 py-2 bg-[#E52328] text-white rounded-lg text-xs font-bold hover:bg-[#c81e22] transition-all flex items-center gap-1.5 mx-auto cursor-pointer"
                  >
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-2">
                              <h4 className="text-xs font-bold text-[#181E2B] truncate">
                                {proj.name}
                              </h4>
                              {isAlreadyIn && (
                                <span className="text-[10px] bg-amber-50 text-amber-700 font-semibold px-1.5 py-0.2 rounded border border-amber-200">
                                  Indeholder script
                                </span>
                              )}
                            </div>
                        ...
                        <div className="shrink-0">
                          {isLoading ? (
                            ...
                            <span className="text-xs font-bold text-[#E52328] hover:underline">
            ...
            <form onSubmit={handleCreateAndSave} className="space-y-3">
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 bg-[#E52328] hover:bg-[#c81e22] text-white rounded-lg text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                {isCreatingProject ? (
                  <>
