    ...
    <div className="fixed inset-0 z-50 bg-slate-900/95 backdrop-blur-md flex flex-col justify-between p-4 md:p-8 animate-fadeIn">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-slate-800 p-1 rounded-md border border-slate-700">
            ...
            <button
              ...
              className="px-2 py-0.5 text-xs text-slate-300 hover:text-white bg-slate-700/50 rounded cursor-pointer"
            >
              A-
            </button>
            <span className="text-xs font-mono text-red-300 w-6 text-center font-bold">{fontSize}</span>
            <button
          ...
          {/* Speed */}
          <div className="flex items-center gap-2 bg-slate-800 px-3 py-1 rounded-md border border-slate-700 text-xs">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer shadow-sm ${
              isPlaying
      ...
      >
        ...
        <div className="sticky top-1/3 left-0 right-0 h-0.5 bg-indigo-500/30 pointer-events-none flex items-center justify-end">
          <span className="text-[10px] text-indigo-400 bg-slate-900 px-2 rounded-full border border-indigo-500/30 -mr-8">
            ØJENHØJDE
          </span>
        </div>
        ...
        <div className="space-y-12 text-center text-slate-100 font-medium">
          ...
          <div className="p-6 bg-indigo-950/40 border border-indigo-500/30 rounded-2xl">
            <span className="text-xs uppercase font-bold text-indigo-400 tracking-widest block mb-2">
            ...
            <span className="text-xs text-indigo-300/70 block mt-2 font-normal">
          ...
          {script.scenes.map((scene, idx) => (
            <div key={scene.id} className="p-4 rounded-xl space-y-2">
              ...
              {scene.textOnScreen && (
                <div className="text-sm text-amber-300/80 font-normal">
