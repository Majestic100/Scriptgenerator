...
export const TeleprompterModal: React.FC<TeleprompterModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-ink/95 backdrop-blur-md flex flex-col justify-between p-4 md:p-8 animate-fadeIn">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4 max-w-4xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          {/* Font size */}
          <div className="flex items-center gap-1 bg-ink p-1 rounded-[var(--radius-control)] border border-slate-700">
            <Type className="w-3.5 h-3.5 text-muted ml-1" />
            <button
          ...
          <div className="flex items-center gap-2 bg-ink px-3 py-1 rounded-[var(--radius-control)] border border-slate-700 text-base">
            ...
            <input
              ...
              className="w-16 accent-rec cursor-pointer"
            />
          </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-[var(--radius-control)] font-bold text-base flex items-center gap-1.5 transition-all cursor-pointer shadow-sm ${
              isPlaying
                ? 'bg-amber-500 hover:bg-rec text-slate-950 font-bold'
                : 'bg-rec hover:bg-rec-hover text-white'
            }`}
          >
          ...
          <button
            onClick={onClose}
            className="p-2 bg-ink hover:bg-red-500/20 text-slate-300 hover:text-red-400 rounded-[var(--radius-control)] border border-slate-700 cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
      ...
      <div
        ref={containerRef}
        className="flex-1 overflow-y-auto max-w-3xl mx-auto w-full my-6 py-12 px-6 scroll-smooth border-y border-slate-800/60 bg-ink/40 rounded-2xl"
