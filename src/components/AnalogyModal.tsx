  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-3 md:p-6 animate-fadeIn overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-3xl max-h-[90vh] flex flex-col my-auto overflow-hidden">
        ...
        {appliedNotice && (
          <div className="bg-emerald-600 text-white text-xs font-bold py-2 px-4 text-center shrink-0 flex items-center justify-center gap-1.5">
        ...
        <div className="p-5 space-y-4 overflow-y-auto flex-1 bg-slate-50/50">
          ...
          <div className="bg-white p-3.5 rounded-xl border border-slate-200 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <button
                ...
                className="px-3.5 py-1.5 bg-amber-500 hover:bg-amber-600 text-amber-950 rounded-lg text-xs font-extrabold flex items-center gap-1.5 transition-all cursor-pointer disabled:opacity-50"
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs outline-none focus:border-[#E52328] focus:bg-white"
              />
            </div>
          </div>
          ...
          {currentText && (
            <div className="bg-amber-50/70 border border-amber-200 p-3 rounded-xl text-xs space-y-1">
              <span className="font-bold text-amber-900 uppercase tracking-wider block text-[10px]">
          ...
          <div className="space-y-3">
            {isGeneratingAi ? (
              <div className="text-center py-10 bg-white rounded-xl border border-slate-200 p-6 space-y-2">
                ...
                <p className="text-xs font-semibold text-slate-600">AI skræddersyr 5 nye analogier til din tekst...</p>
              </div>
            ) : filteredAnalogies.length === 0 ? (
              <div className="text-center py-8 bg-white rounded-xl border border-dashed border-slate-300 p-4">
                <p className="text-xs font-medium text-slate-500 mb-2">Ingen analogier fundet for søgningen</p>
                <button
                  onClick={handleGenerateAiAnalogies}
                  className="px-3 py-1.5 bg-[#E52328] text-white rounded-lg text-xs font-bold inline-flex items-center gap-1 cursor-pointer"
                >
                    ...
                    >
                      <div className="space-y-2.5">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {isAdded && (
                              <span className="px-2.5 py-0.5 bg-[#FEF08A] text-amber-950 border border-amber-400 rounded-full text-[11px] font-black flex items-center gap-1 shadow-xs">
                        ...
                        {/* 1. ANALOGI ALENE */}
                        <div className="text-xs font-semibold text-slate-800 bg-slate-50 border border-slate-200/90 p-2.5 rounded-lg">
                        ...
                        <div className="text-xs font-semibold text-slate-900 bg-amber-50/70 border border-amber-200/90 p-2.5 rounded-lg relative">
                      ...
                      <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2 flex-wrap">
                        <button
                          ...
                          className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded text-xs font-medium flex items-center gap-1 cursor-pointer"
                        ...
                        <div className="flex items-center gap-1.5">
                          {currentType === 'body' && (
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-amber-100 hover:bg-amber-200 text-amber-900 border border-amber-300 rounded-lg text-xs font-bold flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                          ...
                          {currentType === 'hook' ? (
                            <button
                              ...
                              className="px-3.5 py-1.5 bg-[#E52328] hover:bg-red-700 text-white rounded-lg text-xs font-extrabold flex items-center gap-1.5 cursor-pointer shadow-xs"
                            >
                            ...
                            <button
                              ...
                              className="px-3.5 py-1.5 bg-slate-900 hover:bg-slate-800 text-white rounded-lg text-xs font-extrabold flex items-center gap-1.5 cursor-pointer shadow-xs"
                            >
          ...
          <form onSubmit={handleAddCustom} className="pt-2 flex items-center gap-2">
            <input
              ...
              className="flex-1 bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-xs outline-none focus:border-slate-400"
            />
            <button
              type="submit"
              disabled={!customAnalogy.trim()}
              className="px-3 py-1.5 bg-slate-800 hover:bg-slate-900 text-white rounded-lg text-xs font-bold flex items-center gap-1 cursor-pointer disabled:opacity-40"
            >
